...
export function calculateDetailedPrice(
  ...
  for (let i = 0; i < numberOfNights; i++) {
    ...
    if (rate === null) {
      console.warn(`料金が設定されていません: ${seasonType}, ${nightCategory}, ${dayType}, ${guestCount}名`)
      // デフォルト料金を使用（例: 30000円）
...
export function createDemoPricingSetting(): DetailedPricingSetting {
  const seasonPeriods = [
    // オフシーズン: 1月-2月、6月-7月
    { seasonType: 'off' as SeasonType, startDate: '01-01', endDate: '02-28', description: '冬のオフシーズン' },
    { seasonType: 'off' as SeasonType, startDate: '06-01', endDate: '07-15', description: '梅雨時期' },

    // ハイシーズン: 3月-5月、8月、12月
    { seasonType: 'high' as SeasonType, startDate: '03-01', endDate: '05-31', description: '春のハイシーズン' },
    { seasonType: 'high' as SeasonType, startDate: '08-01', endDate: '08-31', description: '夏のハイシーズン' },
    { seasonType: 'high' as SeasonType, startDate: '12-20', endDate: '12-31', description: '年末のハイシーズン' },

    // レギュラーシーズン: 7月後半、9月-11月、12月前半
    { seasonType: 'regular' as SeasonType, startDate: '07-16', endDate: '07-31', description: '夏のレギュラー' },
    { seasonType: 'regular' as SeasonType, startDate: '09-01', endDate: '12-19', description: '秋冬のレギュラー' }
  ]
...
export const usePricing = () => {
  const calculatePrice = (
    ...
    return calculateDetailedPrice(startDate, endDate, guestCount, pricingSetting, couponDiscountRate)
  }
