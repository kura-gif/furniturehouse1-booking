...
export const useSeo = () => {
  ...
  const siteUrl =
    config.public.siteUrl || "https://booking.furniturehouse1.com";
  ...
  const setLodgingBusinessSchema = (data?: Partial<LodgingBusinessData>) => {
    const defaultData: LodgingBusinessData = {
      name: "家具の家 No.1",
      description:
        "坂茂氏による1995年の建築作品「家具の家 No.1」。家具が家を支える「体験する建築」。1日1組限定の宿泊体験。",
      image: [
      ...
      checkinTime: "14:00",
      checkoutTime: "10:00",
      amenityFeature: ["Wi-Fi", "エアコン", "キッチン", "バスルーム", "駐車場"],
    };
