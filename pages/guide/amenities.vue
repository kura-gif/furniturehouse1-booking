  ...
  <div class="guide-page guide-organic-bg">
      ...
      <div class="max-w-md mx-auto">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h1 class="guide-title text-2xl text-white">
            {{ $t("guestGuide.amenities.title") }}
          </h1>
        </div>
        <p class="text-sm opacity-90">
          {{ $t("guestGuide.amenities.subtitle") }}
        </p>
      </div>
    </section>
    ...
    <div class="max-w-md mx-auto px-4 py-6">
      ...
      <div class="space-y-8">
        <!-- IHコンロ (注意事項あり) -->
        <section
          v-if="activeCategory === 'all' || activeCategory === 'kitchen'"
          class="bg-white shadow-sm overflow-hidden"
          style="border-radius: 0 !important"
        >
          <div class="bg-amber-50 border-b border-amber-200 px-4 py-2">
            <p
              class="text-xs text-amber-800 font-medium flex items-center gap-2"
            >
              <svg
                class="w-4 h-4"
                fill="none"
          ...
          <div class="p-4">
            <div class="flex items-center gap-3 mb-3">
              <svg
                class="w-6 h-6 text-organic-accent"
                fill="none"
                stroke="currentColor"
                stroke-width="1.5"
                viewBox="0 0 24 24"
              ...
              <h3 class="guide-title text-base">
                {{ $t("guestGuide.amenities.ih.title") }}
              </h3>
            </div>
            <div
              class="aspect-video bg-organic-border mb-3"
              style="border-radius: 0 !important"
            >
              <img
            ...
            <NuxtLink
              ...
              class="inline-flex items-center gap-1 text-sm text-organic-accent font-medium hover:text-organic-button"
            >
        ...
        >
          <div class="flex items-center gap-3 mb-4">
            ...
            <h2 class="guide-title text-base">
        ...
        <section v-if="activeCategory === 'all' || activeCategory === 'bath'">
          ...
          <div
            class="bg-white p-4 mb-4 shadow-sm"
            style="border-radius: 0 !important"
          >
            <div class="flex items-center gap-3">
              ...
              />
              <div>
                <h3 class="text-sm font-medium text-organic-text mb-1">
                  {{ $t("guestGuide.amenities.bath.shampoo") }}
                </h3>
                <p class="text-xs text-organic-text-light">SOMEWHERE</p>
                <a
                  href="https://somewherebeauty.com/"
                  target="_blank"
                  class="text-xs text-organic-accent hover:underline"
                >
        ...
        <!-- アメニティ -->
        <section
          v-if="activeCategory === 'all' || activeCategory === 'amenity'"
        >
          <div class="flex items-center gap-3 mb-4">
            <svg
              class="w-5 h-5 text-organic-accent"
        ...
        <!-- 家電 -->
        <section
          v-if="activeCategory === 'all' || activeCategory === 'appliance'"
        >
          <div class="flex items-center gap-3 mb-4">
            <svg
              class="w-5 h-5 text-organic-accent"
...
const categories = [
  {
    ...
    labelKey: "guestGuide.amenities.cat.all",
  },
  {
    id: "kitchen",
    iconSvg:
    ...
    labelKey: "guestGuide.amenities.cat.kitchen",
  },
  {
    id: "bath",
    iconSvg:
    ...
    labelKey: "guestGuide.amenities.cat.bath",
  },
  {
    id: "amenity",
    iconSvg:
    ...
    labelKey: "guestGuide.amenities.cat.amenity",
  },
  {
    id: "appliance",
    iconSvg:
      '<svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 20.25h12m-7.5-3v3m3-3v3m-10.125-3h17.25c.621 0 1.125-.504 1.125-1.125V4.125c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125z" /></svg>',
    labelKey: "guestGuide.amenities.cat.appliance",
  },
];
...
const cookingItems = [
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8.25v-1.5m0 1.5c-1.355 0-2.697.056-4.024.166C6.845 8.51 6 9.473 6 10.608v2.513m6-4.87c1.355 0 2.697.055 4.024.165C17.155 8.51 18 9.473 18 10.608v2.513M3 16.5l1.5-.75a3.354 3.354 0 013 0 3.354 3.354 0 003 0 3.354 3.354 0 013 0 3.354 3.354 0 003 0l1.5.75" /></svg>',
    key: "guestGuide.amenities.item.riceCooker",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z" /></svg>',
    key: "guestGuide.amenities.item.coffeeMaker",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3" /></svg>',
    key: "guestGuide.amenities.item.kettle",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6z" /></svg>',
    key: "guestGuide.amenities.item.toaster",
  },
  {
    iconSvg:
    ...
    key: "guestGuide.amenities.item.cassette",
  },
  {
    iconSvg:
    ...
    key: "guestGuide.amenities.item.pot",
  },
  {
    iconSvg:
    ...
    key: "guestGuide.amenities.item.frypan",
  },
];
...
const bathItems = [
  {
    ...
    key: "guestGuide.amenities.item.shampoo",
  },
  {
    iconSvg:
    ...
    key: "guestGuide.amenities.item.bodySoap",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg>',
    key: "guestGuide.amenities.item.bathSalt",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" /></svg>',
    key: "guestGuide.amenities.item.bathMat",
  },
];
...
const amenityItems = [
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0" /></svg>',
    key: "guestGuide.amenities.item.toothbrush",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6z" /></svg>',
    key: "guestGuide.amenities.item.tissue",
  },
  {
    iconSvg:
    ...
    key: "guestGuide.amenities.item.medicine",
  },
  {
    iconSvg:
    ...
    key: "guestGuide.amenities.item.towel",
  },
  {
    iconSvg:
    ...
    key: "guestGuide.amenities.item.bugSpray",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" /></svg>',
    key: "guestGuide.amenities.item.slippers",
  },
];
...
const applianceItems = [
  {
    ...
    key: "guestGuide.amenities.item.dryer",
  },
  {
    iconSvg:
    ...
    key: "guestGuide.amenities.item.speaker",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" /></svg>',
    key: "guestGuide.amenities.item.fan",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" /></svg>',
    key: "guestGuide.amenities.item.washer",
  },
  {
    iconSvg:
      '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z" /></svg>',
    key: "guestGuide.amenities.item.heater",
  },
];
