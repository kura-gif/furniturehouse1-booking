    ...
    <div class="max-w-md mx-auto px-4 py-6">
      ...
      <div class="space-y-3">
        ...
        >
          ...
          >
            <span class="text-sm font-medium text-organic-text pr-4">{{
              $t(faq.questionKey)
            }}</span>
            <svg
          ...
          <Transition name="accordion">
            <div
              ...
              class="border-t border-organic-border"
            >
        ...
        <div class="bg-white p-4 shadow-sm" style="border-radius: 0 !important">
          <div class="flex items-center gap-3 mb-3">
            ...
            <h2 class="guide-title text-base">
              {{ $t("guestGuide.faq.contact.title") }}
            </h2>
          </div>
          <p class="text-sm text-organic-text-light mb-4">
            {{ $t("guestGuide.faq.contact.desc") }}
          </p>
          <a
