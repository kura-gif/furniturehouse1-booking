    ...
    <div class="max-w-4xl mx-auto px-6 md:px-12 py-12">
      ...
      <div class="prose prose-gray max-w-none">
        <div class="mb-8 text-gray-700" style="line-height: 1.8">
          <p>
            家具の家
            No.1のキャンセルポリシーをご確認ください。ご予約の変更・キャンセルは、予約サイトからお手続きいただけます。
          </p>
        </div>
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full border border-gray-300">
              <thead class="bg-gray-50">
                <tr>
                  <th
                    class="px-6 py-4 text-left text-sm font-semibold text-gray-900 border-b border-gray-300"
                  >
                    キャンセル日時
                  </th>
                  <th
                ...
                <tr class="bg-gray-50">
                  ...
                  <td class="px-6 py-4 text-sm text-gray-700">
                    <span class="font-semibold text-red-600">{{
                      settings.cancelPolicyPartialDesc
                    }}</span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-700">
                    <span class="font-semibold text-red-600">{{
                      settings.cancelPolicyNoShowDesc
                    }}</span>
                  </td>
                </tr>
              </tbody>
        ...
        <section class="mb-12">
          ...
          <div class="space-y-4 text-gray-700">
            <div class="bg-blue-50 border-l-4 border-blue-500 p-6">
              <p class="whitespace-pre-line" style="line-height: 1.8">
                {{ settings.cancelPolicyProcedure }}
              </p>
            </div>
            <div>
            ...
            >
              <li
                v-for="(item, index) in parseListItems(
                  settings.cancelPolicyExceptions,
                )"
                :key="index"
              >
                {{ item }}
  ...
  meta: [
    {
      name: "description",
      content:
        "家具の家 No.1のキャンセルポリシー。予約のキャンセル料金、手続き方法をご確認ください。",
    },
    { property: "og:title", content: "キャンセルポリシー | 家具の家 No.1" },
    {
      property: "og:description",
      content: "家具の家 No.1のキャンセルポリシー",
    },
