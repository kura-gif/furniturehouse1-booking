      ...
      <div class="container-responsive max-w-6xl">
        ...
        <div class="text-center mb-12">
          ...
          <p class="text-gray-600">
            日帰りで建築空間を活用したワークショップ・イベントが開催できます
          </p>
        </div>
...
// モックデータ
const bookedDates = ref<Date[]>([new Date(2025, 0, 18), new Date(2025, 0, 22)]);

const unavailableDates = ref<Date[]>([new Date(2025, 0, 28)]);
