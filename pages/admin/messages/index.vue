          ...
          <div class="flex items-start justify-between">
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2 mb-1">
                ...
                <span
                  v-if="conversation.unreadByAdmin > 0"
              ...
              <p
                ...
                class="text-sm text-purple-600 mb-1"
              >
...
import { formatRelativeDate } from "~/composables/useDateFormatting";
...
// formatDate は composables/useDateFormatting から import（相対日付表示）
