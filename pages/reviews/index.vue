      ...
      <div v-else class="space-y-6">
        ...
        >
          <div class="flex items-start justify-between mb-4">
            <div>
              ...
              <p class="text-sm text-gray-500">
                ...
                <span v-if="review.stayType" class="ml-2"
                  >・{{ review.stayType }}</span
                >
              </p>
            </div>
            <div class="flex items-center gap-1">
          ...
          <div
            ...
            class="mt-4 bg-gray-50 rounded-lg p-4 border-l-4 border-purple-500"
          >
...
setBasicMeta({
  ...
  description:
    "家具の家 No.1 に宿泊されたゲストの皆様からのレビューをご覧いただけます。実際に宿泊された方々の声をぜひご参考ください。",
  url: `${siteUrl}/reviews`,
});
  ...
  if (newReviews.length > 0) {
    setReviewSchema(
      newReviews.map((r) => ({
        ...
        datePublished: r.createdAt?.toDate
