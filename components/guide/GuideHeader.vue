<template>
  <header
    class="guide-header fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-organic-border"
  >
      ...
      >
        <nav class="max-w-4xl mx-auto py-4 px-6">
          <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div
                class="w-6 h-6 flex items-center justify-center text-organic-accent"
                v-html="item.iconSvg"
              ></div>
              <div>
                <div class="text-sm font-medium text-organic-text">
                  {{ $t(item.labelKey) }}
                </div>
                <div class="text-xs text-organic-text-light">
                  {{ $t(item.descKey) }}
                </div>
              </div>
            </NuxtLink>
...
const menuItems = [
  {
    ...
    labelKey: "guestGuide.nav.home",
    descKey: "guestGuide.nav.homeDesc",
  },
  {
    to: "/guide/about",
    iconSvg:
    ...
    labelKey: "guestGuide.nav.about",
    descKey: "guestGuide.nav.aboutDesc",
  },
  {
    to: "/guide/checkin",
    iconSvg:
    ...
    labelKey: "guestGuide.nav.checkin",
    descKey: "guestGuide.nav.checkinDesc",
  },
  {
    to: "/guide/amenities",
    iconSvg:
      '<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" /></svg>',
    labelKey: "guestGuide.nav.amenities",
    descKey: "guestGuide.nav.amenitiesDesc",
  },
  {
    to: "/guide/area",
    iconSvg:
    ...
    labelKey: "guestGuide.nav.area",
    descKey: "guestGuide.nav.areaDesc",
  },
  {
    to: "/guide/faq",
    iconSvg:
    ...
    labelKey: "guestGuide.nav.faq",
    descKey: "guestGuide.nav.faqDesc",
  },
];
