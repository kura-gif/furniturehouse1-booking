  ...
  <div class="site-page">
    ...
    <header class="site-header">
      <div class="site-header-inner">
        ...
        <a href="https://www.instagram.com/furniture.house.1/" target="_blank" rel="noopener" class="site-instagram" title="Instagramをフォロー">
    ...
    <footer class="site-footer">
      <div class="site-footer-inner">
        ...
        <div class="site-footer-right">
          ...
          <p class="site-footer-credit">運営：家具の家 no.1 運営委員会 ＋ <a href="https://chladni.co.jp/" target="_blank" rel="noopener" class="site-footer-link">株式会社クラドニ</a></p>
        </div>
      </div>
    </footer>
