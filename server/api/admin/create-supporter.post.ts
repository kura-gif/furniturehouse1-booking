...
import { getFirestoreAdmin, initializeFirebaseAdmin } from '~/server/utils/firebase-admin'
...
export default defineEventHandler(async (event) => {
  ...
  const { email, password, displayName, phone, hourlyRate, transportationFee, isActive } = body
