...
export default defineEventHandler((event) => {
  ...
  const headers = {
    ...
    'Content-Security-Policy': [
      ...
      "connect-src 'self' https://*.firebaseio.com https://*.googleapis.com https://firebasestorage.googleapis.com https://api.stripe.com https://furniturehouse1.com https://www.furniturehouse1.com https://booking.furniturehouse1.com",
